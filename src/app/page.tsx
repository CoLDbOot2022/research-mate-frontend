                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <motion.div 
                      ...
                      className="absolute top-full mt-0.5 left-1/2 -translate-x-1/2 whitespace-nowrap bg-blue-100/90 backdrop-blur-sm text-blue-600 text-[10px] font-bold px-2.5 py-1.5 rounded-lg border border-blue-200 shadow-lg z-10"
                    >
